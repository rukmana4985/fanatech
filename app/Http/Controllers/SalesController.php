...
class SalesController extends Controller
{
    ...
    public function __construct(Sales $main_model){
        $this->view         = 'sales';
        $this->title        = 'Sales';
        $this->main_model   = $main_model;
        $this->validate     = 'SalesRequest';
    ...
    public function store(SalesRequest $request)
    {
        ...
        try{
            ...
            foreach($input['inventory_id'] as $k => $v)
            {
                ...
                SalesDetail::create($input_detail);
            ...
            Alert::success('Terjadi Kesalahan yaitu ',$e->getMessage());
            DB::rollback();
        }
    ...
    public function update(SalesRequest $request, $id)
    {
        ...
        try{
            ...
            foreach($data->sales_details as $detail){
                ...
                $update_stock['stock'] = $stock;
                $inventory->fill($update_stock)->save();
                SalesDetail::whereSalesId($data->id)->delete();
            }
